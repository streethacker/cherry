...
" Vim UI {
	...
	highlight clear SignColumn      " SignColumn should match ackground
...
"	set nowrap                      " Do not wrap long lines
	...
	autocmd Filetype c setlocal ts=2 sw=2 sts=2 expandtab nolist
	...
	autocmd BufRead,BufNewFile *.c setlocal ts=2 sw=2 sts=2 expandtab nolist
	autocmd BufRead,BufNewFile *.h setlocal ts=2 sw=2 sts=2 expandtab nolist
	autocmd BufRead,BufNewFile *.vim setlocal ts=8 sw=8 sts=8 noexpandtab
" }
...
" vim-buffergator {
	...
	" height of the Buffergator window in horizontal splitting mode
...
" mdown {
	"nnoremap <leader>pp :Mpreview<cr>
" }
